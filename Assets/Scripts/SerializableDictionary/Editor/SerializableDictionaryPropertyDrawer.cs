...
{
	public const string KeysFieldName = "m_keys";
	public const string ValuesFieldName = "m_values";
	protected const float IndentWidth = 15f;

	public static GUIContent s_iconPlus = IconContent ("Toolbar Plus", "Add entry");
	public static GUIContent s_iconMinus = IconContent ("Toolbar Minus", "Remove entry");
	...
	public static GUIContent s_warningIconConflict = IconContent ("console.warnicon.sml", "Conflicting key, this entry will be lost");
	public static GUIContent s_warningIconOther = IconContent ("console.infoicon.sml", "Conflicting key");
	public static GUIContent s_warningIconNull = IconContent ("console.warnicon.sml", "Null key, this entry will be lost");
	public static GUIStyle s_buttonStyle = GUIStyle.none;
	public static GUIContent s_tempContent = new GUIContent();
	...
	{
		//Debug.Log("DrawKeyValueLineSimple");
	...
	{
		//Debug.Log("DrawKeyValueLineExpand");
		float labelWidth = EditorGUIUtility.labelWidth;
	...
	public static ConflictState GetConflictState(SerializedProperty property)
	{
	...
	static public  IEnumerable<EnumerationEntry> EnumerateEntries(SerializedProperty keyArrayProperty, SerializedProperty valueArrayProperty, int startIndex = 0)
	{
